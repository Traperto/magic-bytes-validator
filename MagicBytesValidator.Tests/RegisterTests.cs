...
namespace MagicBytesValidator.Tests
{
    public class RegisterTests
    {
        ...
        public RegisterTests()
        {
            ...
            _trpFileType = new FileType(new[] { "traperto/trp" }, new[] { "trp" },
        ...
        {
            var neonJsFileType = new FileType(new[] { "traperto/niklasschmidt" }, new[] { "nms" },
                new[]
                {
                    new byte[]
                    {
            ...
            var kryptobiFileType = new FileType(new[] { "traperto/tobiasjanssen" }, new[] { "tjn" },
                new[]
                {
                    new byte[]
                    {
    ...
    {
        public AssemblyFacade() : base(new[] { "facade/trp" }, new[] { "trp" },
